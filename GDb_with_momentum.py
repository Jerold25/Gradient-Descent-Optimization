...
def update_parameters_velocity(parameters, gradients, epoch, velocity, beta, learning_rate=0.1, decay_rate=0.01):
    '''
    ...
    for i in range(L):
        ...
        parameters["W" + str(i + 1)] = parameters["W" + str(i + 1)] - learning_rate * velocity["dW" + str(i + 1)]
        parameters["b" + str(i + 1)] = parameters["b" + str(i + 1)] - learning_rate * velocity["db" + str(i + 1)]

    return parameters, alpha, velocity
...
def multi_layer_network(X, Y, validation_data, validation_label, net_dims, num_iterations=500, learning_rate=0.1,
    ...
    for ii in range(num_iterations):
        for jj in range(batch_length):
            ...
            parameters, alpha, velocity = update_parameters_velocity(parameters, gradients, ii, v, beta, learning_rate, decay_rate)
            # print parameters
            # if ii ==1:
            #     print "Iteration 2"
            #     print "dz : ",dZ
