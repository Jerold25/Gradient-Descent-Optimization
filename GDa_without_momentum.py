...
def update_parameters(parameters, gradients, epoch, learning_rate=0.1, decay_rate=0.1):
    '''
...
def main():
    ...
    orig_train_data, orig_train_label, test_data, test_label = mnist(noTrSamples=6000, noTsSamples=1000,
